...
const Index = () => {
  const stats = [
    {
      number: "350,000",
      label: "Cardiac arrests occur outside hospitals annually in the U.S.",
    },
    {
      number: "10%",
      label: "Current survival rate for out-of-hospital cardiac arrest",
    },
    {
      number: "6",
  ...
  const challenges = [
    {
      ...
      description:
        "Many communities lack readily available AEDs and knowledge of their locations.",
    },
    {
      title: "Insufficient CPR Training",
      description:
        "Underserved areas have limited access to quality CPR education and training programs.",
    },
    {
      title: "Expensive Certification",
      description:
        "Traditional certification programs can be costly and inaccessible to many communities.",
    },
    {
      title: "Awareness Gap",
      description:
        "Many people don't know how to recognize cardiac emergencies or respond appropriately.",
    },
  ];
      ...
      >
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed">
            Action4AED is dedicated to AED awareness, hands-on CPR education, and
            outreach to underserved communities. Together, we can make life-saving
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <Button
              ...
              onClick={() =>
                window.open(
                  "https://docs.google.com/forms/d/e/1FAIpQLSe4-LWUT3cuagyq-fOCK6OLQafkF4FlqATcIr7yiAG5-XSNlA/viewform",
                  "_blank"
                )
              }
            >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              Action4AED is a youth-led nonprofit dedicated to AED awareness,
              hands-on CPR education, and outreach to underserved communities. We
              host educational events, partner with health departments and schools,
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto">
              Every year, 350,000 cardiac arrests occur outside of hospitals in the
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Your donation helps us reach more communities with lifesaving
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-primary-foreground/80 text-base leading-relaxed">
                Youth-led nonprofit dedicated to AED awareness, hands-on CPR
